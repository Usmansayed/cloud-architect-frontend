...
const steps = [
  {
    ...
    body: 'Read-only Codebase access. strikeloop scans your routes, queries, background jobs, and dependencies. No cloud credentials or deploy permissions needed.',
    ...
    <section id="how-it-works" className="relative overflow-hidden border-t border-border">
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-10 py-12 sm:py-16 md:py-24">
        ...
        <div className="max-w-2xl mb-12 md:mb-16">
          ...
          <h2 className={`${ubuntu.className} text-[26px] sm:text-3xl md:text-4xl font-bold leading-[1.1] tracking-tight mb-4`}>
            Four steps.{' '}
        ...
        <div className="space-y-4">
          {steps.map((step, i) => (
            ...
            >
              {/* Step info  2/5 cols */}
              <div className="lg:col-span-2 p-5 sm:p-6 md:p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-border">
                <div>
                  <div className="flex items-center justify-between mb-5">
                    <span
                      className={`${ubuntu.className} text-[52px] font-black leading-none select-none`}
                      style={{ color: step.highlight ? 'rgba(99,102,241,0.18)' : 'rgba(59,130,246,0.15)' }}
                    >
                      {step.n}
                    </span>
                    <span
                      className="font-sans font-medium text-[10px] px-2.5 py-1 rounded-full uppercase tracking-wider"
                      style={
                        step.highlight
                  ...
                  <p className="font-sans font-medium text-[14px] leading-relaxed text-muted-foreground">
                    {step.body}
                  </p>
                </div>
              </div>
